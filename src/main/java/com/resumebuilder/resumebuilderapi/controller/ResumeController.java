...
import com.resumebuilder.resumebuilderapi.service.ResumeService;
...
public class ResumeController {
    ...
    public ResponseEntity<?> getResumeById(@PathVariable String id,
        ...
        //Step 1: Call the service method
        Resume exisitingResume = resumeService.getResumeById(id,authentication.getPrincipal());

        //Step 2: return response
        return ResponseEntity.ok(exisitingResume);
    }
